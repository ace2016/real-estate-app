...
st.caption(f"Smart valuation using historical UK housing data ({TRAINING_YEARS}) adjusted for 2024 using inflation and market trends. By using this product, you give consent to use the information in order to improve the application, according to <a href='https://gdpr-info.eu/'>GDPR</a>", unsafe_allow_html=True)
